...
function(n, o, t, r, f) {
	...
	}, a.modules = n, a.cache = d, a.parent = u, a.register = function(e, o) {
		n[e] = [function(e, n) {
			n.exports = o
		}, {}]
	...
	if (t) {
		var c = a(t);
		"object" == typeof exports && "undefined" != typeof module ? module.exports = c : "function" == typeof e && e.amd ? e(function() {
			return c
		}) : f && (this[f] = c)
	}
}({
	aYemC: [function(e, n, o) {
		var t = arguments[3],
			r = function() {
		...
		n.exports = o = r.fetch, r.fetch && (o.default = r.fetch.bind(r)), o.Headers = r.Headers, o.Request = r.Request, o.Response = r.Response
	}, {}]
}, ["aYemC"], "aYemC", "parcelRequirea88a"), globalThis.define = n;