...
function(t, r, s, i, n) {
	...
	}, h.modules = t, h.cache = l, h.parent = o, h.register = function(e, r) {
		t[e] = [function(e, t) {
			t.exports = r
		}, {}]
	...
	kgW6q: [function(e, t, r) {
		e("./messaging"), e("../../../background/index"), e("./main-world-scripts")
	}, {
		"./messaging": "iG3ww",
	...
	iG3ww: [function(e, t, r) {
		...
		globalThis.__plasmoInternalPortMap = new Map, chrome.runtime.onMessageExternal.addListener((e, t, r) => {
			switch (e.name) {
			...
			globalThis.__plasmoInternalPortMap.set(e.name, e), e.onMessage.addListener(function(t) {
				e.name
			})
		})
	}, {
			...
			n = async (e, t) => {
				try {
					...
					a.error ? t.send({
						success: !1,
						message: a.error
					}) : (await i.set("enterprise_license", e.body.license), t.send({
						success: !0
					}))
				} catch (e) {
					t.send({
	...
	d6Dja: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "BaseStorage", () => o), s.export(r, "Storage", () => l);
		var i = e("pify"),
			n = s.interopDefault(i),
			a = () => {
				try {
					let e = globalThis.navigator?.userAgent.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i) || [];
					if ("Chrome" === e[1]) return 100 > parseInt(e[2]) || globalThis.chrome.runtime?.getManifest()?.manifest_version === 2
				} catch {}
				return !1
			},
			o = class {
				...
				constructor({
					...
					this.setCopiedKeySet(r), this.#s = e, this.#a = t, this.serde = {
						...this.serde,
						...s
					};
					try {
					...
					try {
						this.hasExtensionApi && (this.#e = this.getExtStorageApi(), a() ? this.#t = (0, n.default)(this.#e[this.area], {
				...
				getAll = async () => Object.entries(await this.rawGetAll()).filter(([e]) => this.isValidKey(e)).reduce((e, [t, r]) => (e[this.getUnnamespacedKey(t)] = r, e), {});
				copy = async e => {
					let t = void 0 === e;
				...
				rawGetMany = async e => this.hasExtensionApi ? await this.#t.get(e) : e.filter(this.isCopied).reduce((e, t) => (e[t] = this.#r?.getItem(t), e), {});
				rawSet = async (e, t) => await this.rawSetMany({
					[e]: t
				});
				rawSetMany = async e => (this.#r && Object.entries(e).filter(([e]) => this.isCopied(e)).forEach(([e, t]) => this.#r.setItem(e, t)), this.hasExtensionApi && await this.#t.set(e), null);
				clear = async (e = !1) => {
				...
				rawRemoveMany = async e => {
					this.#r && e.filter(this.isCopied).forEach(e => this.#r.removeItem(e)), this.hasExtensionApi && await this.#t.remove(e)
				};
				removeAll = async () => {
				...
				#o = e => {
					for (let t in e) {
						...
						let i = (e, t) => {
							...
							let s = this.#i.get(r);
							if (!s) throw Error(`Storage comms does not exist for nsKey: ${r}`);
							Promise.all([this.parseValue(e[r].newValue), this.parseValue(e[r].oldValue)]).then(([e, r]) => {
								for (let i of s.callbackSet) i({
									newValue: e,
									oldValue: r
								}, t)
							})
						};
						this.#e.onChanged.addListener(i), this.#i.set(r, {
							callbackSet: s,
							listener: i
						})
					}
				...
				#l(e) {
					for (let t in e) {
						let r = this.getNamespacedKey(t),
							s = e[t],
							i = this.#i.get(r);
						i && (i.callbackSet.delete(s), 0 === i.callbackSet.size && (this.#i.delete(r), this.#e.onChanged.removeListener(i.listener)))
					}
				}
				unwatchAll = () => this.#c();
				#c() {
					this.#i.forEach(({
						listener: e
					}) => this.#e.onChanged.removeListener(e)), this.#i.clear()
				}
				async getItem(e) {
					return this.get(e)
				}
			...
			l = class extends o {
				...
				getMany = async e => {
					...
					return Object.keys(r).reduce((e, t, r) => (e[this.getUnnamespacedKey(t)] = s[r], e), {})
				};
				set = async (e, t) => {
				...
				setMany = async e => {
					let t = Object.entries(e).reduce((e, [t, r]) => (e[this.getNamespacedKey(t)] = this.serde.serializer(r), e), {});
	...
	"9arDK": [function(e, t, r) {
		...
		function a(e, t) {
			...
			let r = typeof e;
			if (!(null !== e && ("object" === r || "function" === r))) throw TypeError(`Expected \`input\` to be a \`Function\` or \`Object\`, got \`${null===e?"null":r}\``);
			let s = (e, r) => {
					let s = n.get(e);
	...
	"9JrCX": [function(e, t, r) {
		...
		let i = async (e, t) => {
			try {
				...
				"startBot" == e.action ? (await r.set("agent-x-running-tabs", {
					...i,
					[e.tabId]: !0
					...
					action: "startBot"
				})) : "stopBot" == e.action && (await r.set("agent-x-running-tabs", {
					...i,
					[e.tabId]: !1
				}), chrome.tabs.sendMessage(e.tabId, {
					action: "stopBot"
	...
	"45UhA": [function(e, t, r) {
		e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
		let s = async (e, t) => {
			e.sender?.tab?.id ? (chrome.tabs.sendMessage(e.sender.tab.id, e.body), console.log("sent message"), t.send({
				success: !0,
				tabId: e.sender.tab.id
			})) : (console.log("no active tab"), t.send({
				success: !1,
			...
			n = async (e, t) => {
				try {
					...
					l.error ? t.send({
						success: !1,
						message: l.error
					}) : ("active" == l.status ? l.quick = "following" : l.quick = null, t.send({
						success: !0,
						data: l
					}))
				} catch (e) {
	...
	"39szc": [function(e, t, r) {
		e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), new(e("@plasmohq/storage")).Storage;
		let s = async (e, t) => {
			try {
			...
			a = async (e, t) => {
				try {
					let r = chrome.runtime.getManifest(),
						...
						h = c.find(t => t.tweetId === e.pageTweetId || t.replies?.find(t => t.id === e.pageTweetId));
					if (!h) throw Error("Error loading tweet. Try refreshing the page.");
					let u = await i.get("settings"),
						d = {
							method: "POST",
							headers: {
								Accept: "application/json",
						...
						p = await fetch("https://xtensions.pro/api/reply", d),
						f = await p.json();
					if (!p.ok) throw f;
					t.send(f)
				} catch (e) {
		...
		let i = new s.Storage,
			n = async (e, t) => {
				try {
					...
					r && (n.l = r);
					let a = new URLSearchParams(n).toString(),
						o = await fetch(`https://xtensions.pro/api/replies-available?${a}`, {
							method: "GET",
							headers: {
								Accept: "application/json",
								"Content-Type": "application/json"
	...
	"6b7iX": [function(e, t, r) {
		e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r);
		let s = async (e, t) => {
			try {
				let e = await fetch("https://xtensions.pro/api/extension-info/reply-ninja", {
						method: "GET",
						headers: {
							Accept: "application/json",
							"Content-Type": "application/json"
	...
	lzEE8: [function(e, t, r) {
		...
		let i = async (e, t) => {
			await (0, s.supabase).auth.setSession(e.body), t.send({
				success: !0
			})
		};
		r.default = i
	...
	"9q9KP": [function(e, t, r) {
		...
		let a = new n.Storage({
			...
			o = (0, i.createClient)("https://xgbtjpdswaudjhsbnpbn.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhnYnRqcGRzd2F1ZGpoc2JucGJuIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY0NDc0OTYsImV4cCI6MjAxMjAyMzQ5Nn0.Gxk8lidQjK21EVzBl7seDXcu5QgUPB1pjAu38_yw030", {
				auth: {
					storage: a,
					autoRefreshToken: !0,
					persistSession: !0,
	...
	d1Qgp: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "FunctionsHttpError", () => o.FunctionsHttpError), s.export(r, "FunctionsFetchError", () => o.FunctionsFetchError), s.export(r, "FunctionsRelayError", () => o.FunctionsRelayError), s.export(r, "FunctionsError", () => o.FunctionsError), s.export(r, "SupabaseClient", () => n.default), s.export(r, "createClient", () => c);
	...
	iIBPi: [function(e, t, r) {
		...
		r.default = class {
			constructor(e, t, r) {
				...
				this.realtimeUrl = `${y}/realtime/v1`.replace(/^http/i, "ws"), this.authUrl = `${y}/auth/v1`, this.storageUrl = `${y}/storage/v1`, this.functionsUrl = `${y}/functions/v1`;
				...
				this.storageKey = null !== (n = null === (s = w.auth) || void 0 === s ? void 0 : s.storageKey) && void 0 !== n ? n : "", this.headers = null !== (o = null === (a = w.global) || void 0 === a ? void 0 : a.headers) && void 0 !== o ? o : {}, this.auth = this._initSupabaseAuthClient(null !== (h = w.auth) && void 0 !== h ? h : {}, this.headers, null === (g = w.global) || void 0 === g ? void 0 : g.fetch), this.fetch = (0, l.fetchWithAuth)(t, this._getAccessToken.bind(this), null === (m = w.global) || void 0 === m ? void 0 : m.fetch), this.realtime = this._initRealtimeClient(Object.assign({
					headers: this.headers
				}, w.realtime)), this.rest = new i.PostgrestClient(`${y}/rest/v1`, {
					headers: this.headers,
					schema: null === (b = w.db) || void 0 === b ? void 0 : b.schema,
					fetch: this.fetch
			...
			_handleTokenChanged(e, t, r) {
				("TOKEN_REFRESHED" === e || "SIGNED_IN" === e) && this.changedAccessToken !== r ? (this.realtime.setAuth(null != r ? r : null), this.changedAccessToken = r) : "SIGNED_OUT" === e && (this.realtime.setAuth(this.supabaseKey), "STORAGE" == t && this.auth.signOut(), this.changedAccessToken = void 0)
			}
		}
	}, {
	...
	dXCBT: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "FunctionsClient", () => i.FunctionsClient), s.export(r, "FunctionsError", () => n.FunctionsError), s.export(r, "FunctionsFetchError", () => n.FunctionsFetchError), s.export(r, "FunctionsHttpError", () => n.FunctionsHttpError), s.export(r, "FunctionsRelayError", () => n.FunctionsRelayError);
	...
	jzkYZ: [function(e, t, r) {
		...
		class a {
			constructor(e, {
				...
				this.url = e, this.headers = t, this.fetch = (0, i.resolveFetch)(r)
			}
			setAuth(e) {
			...
			invoke(e, t = {}) {
				var r, s, i, a, o;
				return s = this, i = void 0, a = void 0, o = function*() {
					try {
						let s;
						let {
							headers: i,
	...
	hOeHl: [function(e, t, r) {
		...
		let i = t => {
			let r;
			return r = t || ("undefined" == typeof fetch ? (...t) => e("3a20110e4344548e").then(({
				default: e
			}) => e(...t)) : fetch), (...e) => r(...e)
		}
	}, {
	...
	"1Ksod": [function(e, t, r) {
		...
		}, r.getBaseURL = i, r.getOrigin = function(e) {
	...
	ejpNS: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "FunctionsError", () => i), s.export(r, "FunctionsFetchError", () => n), s.export(r, "FunctionsRelayError", () => a), s.export(r, "FunctionsHttpError", () => o);
	...
	"9sV8Y": [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "PostgrestClient", () => n.default), s.export(r, "PostgrestQueryBuilder", () => o.default), s.export(r, "PostgrestFilterBuilder", () => c.default), s.export(r, "PostgrestTransformBuilder", () => u.default), s.export(r, "PostgrestBuilder", () => p.default);
	...
	"7pXLT": [function(e, t, r) {
		...
		class c {
			constructor(e, {
				...
				this.url = e, this.headers = Object.assign(Object.assign({}, l.DEFAULT_HEADERS), t), this.schemaName = r, this.fetch = s
			}
			from(e) {
			...
			rpc(e, t = {}, {
				...
				r ? (i = "HEAD", Object.entries(t).forEach(([e, t]) => {
					a.searchParams.append(e, `${t}`)
				})) : (i = "POST", n = t);
				let l = Object.assign({}, this.headers);
				return s && (l.Prefer = `count=${s}`), new o.default({
					method: i,
					url: a,
					headers: l,
					schema: this.schemaName,
	...
	"7QdzZ": [function(e, t, r) {
		...
		r.default = class {
			...
			select(e, {
				...
				let s = !1,
					i = (null != e ? e : "*").split("").map(e => /\s/.test(e) && !s ? "" : ('"' === e && (s = !s), e)).join("");
				return this.url.searchParams.set("select", i), r && (this.headers.Prefer = `count=${r}`), new n.default({
					method: t ? "HEAD" : "GET",
					url: this.url,
					headers: this.headers,
					schema: this.schema,
			...
			insert(e, {
				...
				let s = [];
				if (this.headers.Prefer && s.push(this.headers.Prefer), t && s.push(`count=${t}`), r || s.push("missing=default"), this.headers.Prefer = s.join(","), Array.isArray(e)) {
			...
			upsert(e, {
				...
				if (void 0 !== t && this.url.searchParams.set("on_conflict", t), this.headers.Prefer && a.push(this.headers.Prefer), s && a.push(`count=${s}`), i || a.push("missing=default"), this.headers.Prefer = a.join(","), Array.isArray(e)) {
					let t = e.reduce((e, t) => e.concat(Object.keys(t)), []);
					if (t.length > 0) {
						let e = [...new Set(t)].map(e => `"${e}"`);
						this.url.searchParams.set("columns", e.join(","))
			...
			update(e, {
				...
				let r = [];
				return this.headers.Prefer && r.push(this.headers.Prefer), t && r.push(`count=${t}`), this.headers.Prefer = r.join(","), new n.default({
					method: "PATCH",
					url: this.url,
					headers: this.headers,
					schema: this.schema,
			...
			delete({
				...
				let t = [];
				return e && t.push(`count=${e}`), this.headers.Prefer && t.unshift(this.headers.Prefer), this.headers.Prefer = t.join(","), new n.default({
					method: "DELETE",
					url: this.url,
					headers: this.headers,
					schema: this.schema,
	...
	j48fj: [function(e, t, r) {
		...
		class a extends n.default {
			...
			order(e, {
				...
				return this.url.searchParams.set(i, `${n?`${n},`:""}${e}.${t?"asc":"desc"}${void 0===r?"":r?".nullsfirst":".nullslast"}`), this
			}
			limit(e, {
				foreignTable: t
			} = {}) {
				...
				let r = this.fetch,
					s = r(this.url.toString(), {
						...
						if (e.ok) {
							...
							s && c && c.length > 1 && (a = parseInt(c[1])), this.isMaybeSingle && "GET" === this.method && Array.isArray(n) && (n.length > 1 ? (i = {
								code: "PGRST116",
							...
							let t = await e.text();
							try {
								i = JSON.parse(t), Array.isArray(i) && 404 === e.status && (n = [], i = null, o = 200, l = "OK")
							} catch (r) {
								404 === e.status && "" === t ? (o = 204, l = "No Content") : i = {
									message: t
								}
							}
							if (i && this.isMaybeSingle && (null === (s = null == i ? void 0 : i.details) || void 0 === s ? void 0 : s.includes("Results contain 0 rows")) && (i = null, o = 200, l = "OK"), i && this.shouldThrowOnError) throw i
						}
						let c = {
							error: i,
							data: n,
	...
	cfMaT: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "RealtimePresence", () => c.default), s.export(r, "RealtimeChannel", () => o.default), s.export(r, "RealtimeClient", () => n.default), s.export(r, "REALTIME_LISTEN_TYPES", () => a.REALTIME_LISTEN_TYPES), s.export(r, "REALTIME_POSTGRES_CHANGES_LISTEN_EVENT", () => a.REALTIME_POSTGRES_CHANGES_LISTEN_EVENT), s.export(r, "REALTIME_PRESENCE_LISTEN_EVENTS", () => l.REALTIME_PRESENCE_LISTEN_EVENTS), s.export(r, "REALTIME_SUBSCRIBE_STATES", () => a.REALTIME_SUBSCRIBE_STATES);
	...
	afZlD: [function(e, t, r) {
		...
		r.default = class {
			constructor(t, r) {
				var s, a;
				this.accessToken = null, this.channels = [], this.endPoint = "", this.headers = n.DEFAULT_HEADERS, this.params = {}, this.timeout = n.DEFAULT_TIMEOUT, this.transport = i.w3cwebsocket, this.heartbeatIntervalMs = 3e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = d, this.conn = null, this.sendBuffer = [], this.serializer = new c.default, this.stateChangeCallbacks = {
					open: [],
					close: [],
					error: [],
					message: []
				}, this.eventsPerSecondLimitMs = 100, this.inThrottle = !1, this._resolveFetch = t => {
					let r;
					return r = t || ("undefined" == typeof fetch ? (...t) => e("9173380d96a04ca4").then(({
						default: e
					}) => e(...t)) : fetch), (...e) => r(...e)
				}, this.endPoint = `${t}/${n.TRANSPORTS.websocket}`, (null == r ? void 0 : r.params) && (this.params = r.params), (null == r ? void 0 : r.headers) && (this.headers = Object.assign(Object.assign({}, this.headers), r.headers)), (null == r ? void 0 : r.timeout) && (this.timeout = r.timeout), (null == r ? void 0 : r.logger) && (this.logger = r.logger), (null == r ? void 0 : r.transport) && (this.transport = r.transport), (null == r ? void 0 : r.heartbeatIntervalMs) && (this.heartbeatIntervalMs = r.heartbeatIntervalMs);
				...
				h && (this.accessToken = h), this.reconnectAfterMs = (null == r ? void 0 : r.reconnectAfterMs) ? r.reconnectAfterMs : e => [1e3, 2e3, 5e3, 1e4][e - 1] || 1e4, this.encode = (null == r ? void 0 : r.encode) ? r.encode : (e, t) => t(JSON.stringify(e)), this.decode = (null == r ? void 0 : r.decode) ? r.decode : this.serializer.decode.bind(this.serializer), this.reconnectTimer = new o.default(async () => {
					this.disconnect(), this.connect()
				}, this.reconnectAfterMs), this.fetch = this._resolveFetch(null == r ? void 0 : r.fetch)
			}
			connect() {
			...
			_onConnMessage(e) {
				this.decode(e.data, e => {
					...
					(i && i === this.pendingHeartbeatRef || r === (null == s ? void 0 : s.type)) && (this.pendingHeartbeatRef = null), this.log("receive", `${s.status||""} ${t} ${r} ${i&&"("+i+")"||""}`, s), this.channels.filter(e => e._isMember(t)).forEach(e => e._trigger(r, s, i)), this.stateChangeCallbacks.message.forEach(t => t(e))
				})
			}
			_onConnOpen() {
			...
			_sendHeartbeat() {
				...
				if (this.isConnected()) {
					if (this.pendingHeartbeatRef) {
						this.pendingHeartbeatRef = null, this.log("transport", "heartbeat timeout. Attempting to re-establish connection"), null === (e = this.conn) || void 0 === e || e.close(n.WS_CLOSE_NORMAL, "hearbeat timeout");
						return
					}
	...
	lKCFE: [function(e, t, r) {
		...
		var s, i = s.WebSocket || s.MozWebSocket,
	...
	j8pWV: [function(e, t, r) {
		...
		d.defineInteropFlag(r), d.export(r, "DEFAULT_HEADERS", () => f), d.export(r, "VSN", () => g), d.export(r, "DEFAULT_TIMEOUT", () => m), d.export(r, "WS_CLOSE_NORMAL", () => b), d.export(r, "SOCKET_STATES", () => o), d.export(r, "CHANNEL_STATES", () => l), d.export(r, "CHANNEL_EVENTS", () => c), d.export(r, "TRANSPORTS", () => h), d.export(r, "CONNECTION_STATE", () => u);
		var p = e("./version");
		let f = {
			...
			m = 1e4,
			b = 1e3;
		(s = o || (o = {}))[s.connecting = 0] = "connecting", s[s.open = 1] = "open", s[s.closing = 2] = "closing", s[s.closed = 3] = "closed", (i = l || (l = {})).closed = "closed", i.errored = "errored", i.joined = "joined", i.joining = "joining", i.leaving = "leaving", (n = c || (c = {})).close = "phx_close", n.error = "phx_error", n.join = "phx_join", n.reply = "phx_reply", n.leave = "phx_leave", n.access_token = "access_token", (h || (h = {})).websocket = "websocket", (a = u || (u = {})).Connecting = "connecting", a.Open = "open", a.Closing = "closing", a.Closed = "closed"
	}, {
		"./version": "4i7av",
		"@parcel/transformer-js/src/esmodule-helpers.js": "hbR2Q"
	}],
	...
	iSbep: [function(e, t, r) {
		...
		c.defineInteropFlag(r), c.export(r, "REALTIME_POSTGRES_CHANGES_LISTEN_EVENT", () => a), c.export(r, "REALTIME_LISTEN_TYPES", () => o), c.export(r, "REALTIME_SUBSCRIBE_STATES", () => l);
		...
		(s = a || (a = {})).ALL = "*", s.INSERT = "INSERT", s.UPDATE = "UPDATE", s.DELETE = "DELETE", (i = o || (o = {})).BROADCAST = "broadcast", i.PRESENCE = "presence", i.POSTGRES_CHANGES = "postgres_changes", (n = l || (l = {})).SUBSCRIBED = "SUBSCRIBED", n.TIMED_OUT = "TIMED_OUT", n.CLOSED = "CLOSED", n.CHANNEL_ERROR = "CHANNEL_ERROR";
		class y {
			constructor(e, t = {
				config: {}
			}, r) {
				this.topic = e, this.params = t, this.socket = r, this.bindings = {}, this.state = h.CHANNEL_STATES.closed, this.joinedOnce = !1, this.pushBuffer = [], this.subTopic = e.replace(/^realtime:/i, ""), this.params.config = Object.assign({
					broadcast: {
						ack: !1,
						self: !1
					},
				...
				}, t.config), this.timeout = this.socket.timeout, this.joinPush = new d.default(this, h.CHANNEL_EVENTS.join, this.params, this.timeout), this.rejoinTimer = new f.default(() => this._rejoinUntilConnected(), this.socket.reconnectAfterMs), this.joinPush.receive("ok", () => {
					this.state = h.CHANNEL_STATES.joined, this.rejoinTimer.reset(), this.pushBuffer.forEach(e => e.send()), this.pushBuffer = []
				}), this._onClose(() => {
					this.rejoinTimer.reset(), this.socket.log("channel", `close ${this.topic} ${this._joinRef()}`), this.state = h.CHANNEL_STATES.closed, this.socket._remove(this)
				}), this._onError(e => {
					this._isLeaving() || this._isClosed() || (this.socket.log("channel", `error ${this.topic}`, e), this.state = h.CHANNEL_STATES.errored, this.rejoinTimer.scheduleTimeout())
				}), this.joinPush.receive("timeout", () => {
					this._isJoining() && (this.socket.log("channel", `timeout ${this.topic}`, this.joinPush.timeout), this.state = h.CHANNEL_STATES.errored, this.rejoinTimer.scheduleTimeout())
				}), this._on(h.CHANNEL_EVENTS.reply, {}, (e, t) => {
					this._trigger(this._replyEventName(t), e)
				}), this.presence = new m.default(this), this.broadcastEndpointURL = this._broadcastEndpointURL()
			}
						...
						if (this.socket.accessToken && this.socket.setAuth(this.socket.accessToken), void 0 === t) {
							...
							for (let r = 0; r < i; r++) {
								let i = s[r],
									...
									h = t && t[r];
								if (h && h.event === a && h.schema === o && h.table === l && h.filter === c) n.push(Object.assign(Object.assign({}, i), {
									id: h.id
								}));
								else {
			...
			async send(e, t = {}) {
				...
				if (this._canPush() || "broadcast" !== e.type) return new Promise(r => {
					...
					a.rateLimited && r("rate limited"), "broadcast" !== e.type || (null === (n = null === (i = null === (s = this.params) || void 0 === s ? void 0 : s.config) || void 0 === i ? void 0 : i.broadcast) || void 0 === n ? void 0 : n.ack) || r("ok"), a.receive("ok", () => r("ok")), a.receive("timeout", () => r("timed out"))
				});
				{
					let {
						event: i,
			...
			unsubscribe(e = this.timeout) {
				...
				let t = () => {
					this.socket.log("channel", `leave ${this.topic}`), this._trigger(h.CHANNEL_EVENTS.close, "leave", this._joinRef())
				};
			...
			_trigger(e, t, r) {
				...
				if (r && [a, o, l, c].indexOf(n) >= 0 && r !== this._joinRef()) return;
			...
			_off(e, t) {
				...
				return this.bindings[r] = this.bindings[r].filter(e => {
					var s;
					return !((null === (s = e.type) || void 0 === s ? void 0 : s.toLocaleLowerCase()) === r && y.isEqual(e.filter, t))
				}), this
			}
			static isEqual(e, t) {
			...
			_rejoin(e = this.timeout) {
				this._isLeaving() || (this.socket._leaveOpenTopic(this.topic), this.state = h.CHANNEL_STATES.joining, this.joinPush.resend(e))
			}
			_getPayloadRecords(e) {
				...
				return ("INSERT" === e.type || "UPDATE" === e.type) && (t.new = b.convertChangeData(e.columns, e.record)), ("UPDATE" === e.type || "DELETE" === e.type) && (t.old = b.convertChangeData(e.columns, e.old_record)), t
			}
		}
		r.default = y
	}, {
	...
	"7maRr": [function(e, t, r) {
		...
		n.defineInteropFlag(r), n.export(r, "REALTIME_PRESENCE_LISTEN_EVENTS", () => i), (s = i || (i = {})).SYNC = "sync", s.JOIN = "join", s.LEAVE = "leave";
		class a {
			constructor(e, t) {
				...
				this.channel._on(r.state, {}, e => {
					...
					this.joinRef = this.channel._joinRef(), this.state = a.syncState(this.state, e, t, r), this.pendingDiffs.forEach(e => {
					...
					this.inPendingSyncState() ? this.pendingDiffs.push(e) : (this.state = a.syncDiff(this.state, e, t, r), s())
				}), this.onJoin((e, t, r) => {
			...
			static syncDiff(e, t, r, s) {
				...
				return r || (r = () => {}), s || (s = () => {}), this.map(i, (t, s) => {
					...
					i = i.filter(e => 0 > n.indexOf(e.presence_ref)), e[t] = i, s(t, i, r), 0 === i.length && delete e[t]
				}), e
			}
			static map(e, t) {
			...
			static transformState(e) {
				return Object.getOwnPropertyNames(e = this.cloneDeep(e)).reduce((t, r) => {
					let s = e[r];
					return "metas" in s ? t[r] = s.metas.map(e => (e.presence_ref = e.phx_ref, delete e.phx_ref, delete e.phx_ref_prev, e)) : t[r] = s, t
				}, {})
			}
			static cloneDeep(e) {
	...
	lUDaN: [function(e, t, r) {
		var s, i, n = e("@parcel/transformer-js/src/esmodule-helpers.js");
		n.defineInteropFlag(r), n.export(r, "PostgresTypes", () => i), n.export(r, "convertChangeData", () => a), n.export(r, "convertColumn", () => o), n.export(r, "convertCell", () => l), n.export(r, "toBoolean", () => h), n.export(r, "toNumber", () => u), n.export(r, "toJson", () => d), n.export(r, "toArray", () => p), n.export(r, "toTimestampString", () => f), (s = i || (i = {})).abstime = "abstime", s.bool = "bool", s.date = "date", s.daterange = "daterange", s.float4 = "float4", s.float8 = "float8", s.int2 = "int2", s.int4 = "int4", s.int4range = "int4range", s.int8 = "int8", s.int8range = "int8range", s.json = "json", s.jsonb = "jsonb", s.money = "money", s.numeric = "numeric", s.oid = "oid", s.reltime = "reltime", s.text = "text", s.time = "time", s.timestamp = "timestamp", s.timestamptz = "timestamptz", s.timetz = "timetz", s.tsrange = "tsrange", s.tstzrange = "tstzrange";
		let a = (e, t, r = {}) => {
				var s;
				let i = null !== (s = r.skipTypes) && void 0 !== s ? s : [];
				return Object.keys(t).reduce((r, s) => (r[s] = o(s, e, t, i), r), {})
			},
			o = (e, t, r, s) => {
	...
	e2M2J: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "StorageClient", () => i.StorageClient);
	...
	kHv3R: [function(e, t, r) {
		...
		r.default = class {
			constructor(e, t = {}, r, s) {
				this.url = e, this.headers = t, this.bucketId = r, this.fetch = (0, n.resolveFetch)(s)
			}
			uploadOrUpdate(e, t, r, i) {
				return a(this, void 0, void 0, function*() {
					try {
						...
						"undefined" != typeof Blob && r instanceof Blob ? ((s = new FormData).append("cacheControl", n.cacheControl), s.append("", r)) : "undefined" != typeof FormData && r instanceof FormData ? (s = r).append("cacheControl", n.cacheControl) : (s = r, a["cache-control"] = `max-age=${n.cacheControl}`, a["content-type"] = n.contentType);
						...
						if ((0, s.isStorageError)(e)) return {
							data: null,
							error: e
						};
						throw e
			...
			uploadToSignedUrl(e, t, r, i) {
				return a(this, void 0, void 0, function*() {
					...
					try {
						...
						"undefined" != typeof Blob && r instanceof Blob ? ((e = new FormData).append("cacheControl", t.cacheControl), e.append("", r)) : "undefined" != typeof FormData && r instanceof FormData ? (e = r).append("cacheControl", t.cacheControl) : (e = r, s["cache-control"] = `max-age=${t.cacheControl}`, s["content-type"] = t.contentType);
				...
				return a(this, void 0, void 0, function*() {
					try {
						let t = this._getFinalPath(e),
							r = yield(0, i.post)(this.fetch, `${this.url}/object/upload/sign/${t}`, {}, {
								headers: this.headers
							}), n = new URL(this.url + r.url), a = n.searchParams.get("token");
			...
			move(e, t) {
				return a(this, void 0, void 0, function*() {
					try {
						let r = yield(0, i.post)(this.fetch, `${this.url}/object/move`, {
			...
			copy(e, t) {
				return a(this, void 0, void 0, function*() {
					try {
						let r = yield(0, i.post)(this.fetch, `${this.url}/object/copy`, {
							bucketId: this.bucketId,
							sourceKey: e,
							destinationKey: t
						}, {
				...
				return a(this, void 0, void 0, function*() {
					try {
						let s = this._getFinalPath(e),
							n = yield(0, i.post)(this.fetch, `${this.url}/object/sign/${s}`, Object.assign({
								expiresIn: t
							}, (null == r ? void 0 : r.transform) ? {
								transform: r.transform
							} : {}), {
								headers: this.headers
							}), a = (null == r ? void 0 : r.download) ? `&download=${!0===r.download?"":r.download}` : "", o = encodeURI(`${this.url}${n.signedURL}${a}`);
						return {
							data: n = {
								signedUrl: o
							},
			...
			createSignedUrls(e, t, r) {
				return a(this, void 0, void 0, function*() {
					try {
						let s = yield(0, i.post)(this.fetch, `${this.url}/object/sign/${this.bucketId}`, {
							expiresIn: t,
							paths: e
						}, {
							headers: this.headers
			...
			download(e, t) {
				return a(this, void 0, void 0, function*() {
					...
					try {
						let t = this._getFinalPath(e),
							s = yield(0, i.get)(this.fetch, `${this.url}/${r?"render/image/authenticated":"object"}/${t}${a}`, {
								headers: this.headers,
								noResolveJson: !0
							}), n = yield s.blob();
						return {
			...
			remove(e) {
				return a(this, void 0, void 0, function*() {
					try {
						let t = yield(0, i.remove)(this.fetch, `${this.url}/object/${this.bucketId}`, {
							prefixes: e
						}, {
							headers: this.headers
						});
				...
				return a(this, void 0, void 0, function*() {
					try {
						let s = Object.assign(Object.assign(Object.assign({}, o), t), {
							...
							n = yield(0, i.post)(this.fetch, `${this.url}/object/list/${this.bucketId}`, s, {
								headers: this.headers
							}, r);
						return {
							data: n,
	...
	eUAto: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "StorageError", () => i), s.export(r, "isStorageError", () => n), s.export(r, "StorageApiError", () => a), s.export(r, "StorageUnknownError", () => o);
		class i extends Error {
			constructor(e) {
	...
	"8FbLL": [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "get", () => u), s.export(r, "post", () => d), s.export(r, "put", () => p), s.export(r, "remove", () => f);
		var i = e("./errors"),
			n = e("./helpers"),
			a = function(e, t, r, s) {
				return new(r || (r = Promise))(function(i, n) {
		...
		let o = e => e.msg || e.message || e.error_description || e.error || JSON.stringify(e),
			...
			c = (e, t, r, s) => {
				...
				return "GET" === e ? i : (i.headers = Object.assign({
					"Content-Type": "application/json"
				}, null == t ? void 0 : t.headers), i.body = JSON.stringify(s), Object.assign(Object.assign({}, i), r))
			};
	...
	kvI8t: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "resolveFetch", () => i), s.export(r, "resolveResponse", () => n);
		let i = t => {
				let r;
				return r = t || ("undefined" == typeof fetch ? (...t) => e("886a5780b9fafe4c").then(({
					default: e
				}) => e(...t)) : fetch), (...e) => r(...e)
			},
			n = () => {
				var t, r, s, i;
				return t = void 0, r = void 0, s = void 0, i = function*() {
	...
	crQxE: [function(e, t, r) {
		...
		r.default = class {
			constructor(e, t = {}, r) {
				this.url = e, this.headers = Object.assign(Object.assign({}, s.DEFAULT_HEADERS), t), this.fetch = (0, a.resolveFetch)(r)
			}
			listBuckets() {
				return o(this, void 0, void 0, function*() {
					try {
						...
						if ((0, i.isStorageError)(e)) return {
							data: null,
							error: e
						};
						throw e
			...
			getBucket(e) {
				return o(this, void 0, void 0, function*() {
					try {
						let t = yield(0, n.get)(this.fetch, `${this.url}/bucket/${e}`, {
							headers: this.headers
						});
						return {
							data: t,
			...
			createBucket(e, t = {
				...
				return o(this, void 0, void 0, function*() {
					try {
						let r = yield(0, n.post)(this.fetch, `${this.url}/bucket`, {
							id: e,
							name: e,
							public: t.public,
			...
			updateBucket(e, t) {
				return o(this, void 0, void 0, function*() {
					try {
						let r = yield(0, n.put)(this.fetch, `${this.url}/bucket/${e}`, {
							id: e,
							name: e,
							public: t.public,
							file_size_limit: t.fileSizeLimit,
			...
			emptyBucket(e) {
				return o(this, void 0, void 0, function*() {
					try {
						let t = yield(0, n.post)(this.fetch, `${this.url}/bucket/${e}/empty`, {}, {
							headers: this.headers
						});
						return {
							data: t,
			...
			deleteBucket(e) {
				return o(this, void 0, void 0, function*() {
					try {
						let t = yield(0, n.remove)(this.fetch, `${this.url}/bucket/${e}`, {}, {
							headers: this.headers
						});
						return {
							data: t,
	...
	duFZb: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "resolveFetch", () => a), s.export(r, "resolveHeadersConstructor", () => o), s.export(r, "fetchWithAuth", () => l);
		var i = e("cross-fetch"),
			n = s.interopDefault(i);
		let a = e => {
				let t;
				return t = e || ("undefined" == typeof fetch ? n.default : fetch), (...e) => t(...e)
			},
			...
			l = (e, t, r) => {
				...
				return (r, n) => {
					...
					return a = void 0, o = void 0, l = void 0, c = function*() {
						...
						return l.has("apikey") || l.set("apikey", e), l.has("Authorization") || l.set("Authorization", `Bearer ${o}`), s(r, Object.assign(Object.assign({}, n), {
							headers: l
						}))
	...
	"2sitr": [function(e, t, r) {
		...
		(function(e) {
			...
			function p() {
				return this.bodyUsed = !1, this._initBody = function(e) {
					...
					if (this._bodyArrayBuffer) return Promise.resolve(function(e) {
						for (var t = new Uint8Array(e), r = Array(t.length), s = 0; s < t.length; s++) r[s] = String.fromCharCode(t[s]);
						return r.join("")
			...
			function g(e, t) {
				...
				if (this.credentials = t.credentials || this.credentials || "same-origin", (t.headers || !this.headers) && (this.headers = new l(t.headers)), this.method = (s = (r = t.method || this.method || "GET").toUpperCase(), f.indexOf(s) > -1 ? s : r), this.mode = t.mode || this.mode || null, this.signal = t.signal || this.signal, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) throw TypeError("Body not allowed for GET or HEAD requests");
				this._initBody(i)
			}
			...
			function v(r, s) {
				return new Promise(function(i, n) {
					...
					}, o.open(a.method, a.url, !0), "include" === a.credentials ? o.withCredentials = !0 : "omit" === a.credentials && (o.withCredentials = !1), "responseType" in o && t.blob && (o.responseType = "blob"), a.headers.forEach(function(e, t) {
						o.setRequestHeader(t, e)
					}), a.signal && (a.signal.addEventListener("abort", c), o.onreadystatechange = function() {
						4 === o.readyState && a.signal.removeEventListener("abort", c)
					}), o.send(void 0 === a._bodyInit ? null : a._bodyInit)
				})
			}
			v.polyfill = !0, i.fetch || (i.fetch = v, i.Headers = l, i.Request = g, i.Response = b), e.Headers = l, e.Request = g, e.Response = b, e.fetch = v, Object.defineProperty(e, "__esModule", {
				value: !0
			})
		})({}), i.fetch.ponyfill = !0, delete i.fetch.polyfill, (r = i.fetch).default = i.fetch, r.fetch = i.fetch, r.Headers = i.Headers, r.Request = i.Request, r.Response = i.Response, t.exports = r
	}, {}],
	i1iq2: [function(e, t, r) {
		...
		s.defineInteropFlag(r), s.export(r, "uuid", () => i), s.export(r, "stripTrailingSlash", () => n), s.export(r, "isBrowser", () => a), s.export(r, "applySettingDefaults", () => o);
	...
	"214XC": [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "navigatorLock", () => h.navigatorLock), s.export(r, "NavigatorLockAcquireTimeoutError", () => h.NavigatorLockAcquireTimeoutError), s.export(r, "lockInternals", () => h.internals), s.export(r, "GoTrueAdminApi", () => n.default), s.export(r, "GoTrueClient", () => o.default);
	...
	"60Wku": [function(e, t, r) {
		...
		r.default = class {
			constructor({
				...
				this.url = e, this.headers = t, this.fetch = (0, i.resolveFetch)(r), this.mfa = {
			...
			async signOut(e, t = "global") {
				try {
					return await (0, s._request)(this.fetch, "POST", `${this.url}/logout?scope=${t}`, {
						headers: this.headers,
						jwt: e,
						noResolveJson: !0
					}), {
			...
			async inviteUserByEmail(e, t = {}) {
				try {
					return await (0, s._request)(this.fetch, "POST", `${this.url}/invite`, {
						body: {
							email: e,
							data: t.data
						},
			...
			async generateLink(e) {
				try {
					...
					return "newEmail" in r && (i.new_email = null == r ? void 0 : r.newEmail, delete i.newEmail), await (0, s._request)(this.fetch, "POST", `${this.url}/admin/generate_link`, {
						body: i,
						headers: this.headers,
			...
			async createUser(e) {
				try {
					return await (0, s._request)(this.fetch, "POST", `${this.url}/admin/users`, {
						body: e,
						headers: this.headers,
						xform: s._userResponse
					})
			...
			async listUsers(e) {
				...
				try {
					let n = {
						...
						h = await (0, s._request)(this.fetch, "GET", `${this.url}/admin/users`, {
							headers: this.headers,
							noResolveJson: !0,
							query: {
			...
			async getUserById(e) {
				try {
					return await (0, s._request)(this.fetch, "GET", `${this.url}/admin/users/${e}`, {
						headers: this.headers,
						xform: s._userResponse
					})
				} catch (e) {
			...
			async updateUserById(e, t) {
				try {
					return await (0, s._request)(this.fetch, "PUT", `${this.url}/admin/users/${e}`, {
						body: t,
						headers: this.headers,
						xform: s._userResponse
					})
			...
			async deleteUser(e, t = !1) {
				try {
					return await (0, s._request)(this.fetch, "DELETE", `${this.url}/admin/users/${e}`, {
						headers: this.headers,
						body: {
			...
			async _listFactors(e) {
				try {
					let {
						data: t,
						error: r
					} = await (0, s._request)(this.fetch, "GET", `${this.url}/admin/users/${e.userId}/factors`, {
						headers: this.headers,
						xform: e => ({
							data: {
								factors: e
			...
			async _deleteFactor(e) {
				try {
					let t = await (0, s._request)(this.fetch, "DELETE", `${this.url}/admin/users/${e.userId}/factors/${e.id}`, {
						headers: this.headers
					});
					return {
						data: t,
	...
	cXZup: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "_request", () => u), s.export(r, "_sessionResponse", () => p), s.export(r, "_userResponse", () => f), s.export(r, "_ssoResponse", () => g), s.export(r, "_generateLinkResponse", () => m), s.export(r, "_noResolveJsonResponse", () => b);
		var i = e("./helpers"),
			n = e("./errors"),
			a = function(e, t) {
				var r = {};
		...
		async function c(e) {
			let t;
			if (!(0, i.looksLikeFetchResponse)(e)) throw new n.AuthRetryableFetchError(o(e), 0);
			if (l.includes(e.status)) throw new n.AuthRetryableFetchError(o(e), e.status);
			try {
				t = await e.json()
			} catch (e) {
		...
		async function d(e, t, r, s, i, a) {
			...
			if (l.ok || await c(l), null == s ? void 0 : s.noResolveJson) return l;
			try {
				return await l.json()
			} catch (e) {
				await c(e)
		...
		function p(e) {
			var t;
			let r = null;
			e.access_token && e.refresh_token && e.expires_in && (r = Object.assign({}, e), e.expires_at || (r.expires_at = (0, i.expiresAt)(e.expires_in)));
		...
		function m(e) {
			let {
				...
				redirect_to: i,
				verification_type: n
			} = e, o = a(e, ["action_link", "email_otp", "hashed_token", "redirect_to", "verification_type"]), l = Object.assign({}, o);
			return {
				data: {
					properties: {
						action_link: t,
	...
	ltLuR: [function(e, t, r) {
		...
		s.defineInteropFlag(r), s.export(r, "expiresAt", () => i), s.export(r, "uuid", () => n), s.export(r, "isBrowser", () => a), s.export(r, "supportsLocalStorage", () => l), s.export(r, "parseParametersFromURL", () => c), s.export(r, "resolveFetch", () => h), s.export(r, "looksLikeFetchResponse", () => u), s.export(r, "setItemAsync", () => d), s.export(r, "getItemAsync", () => p), s.export(r, "removeItemAsync", () => f), s.export(r, "decodeBase64URL", () => g), s.export(r, "Deferred", () => m), s.export(r, "decodeJWTPayload", () => b), s.export(r, "sleep", () => y), s.export(r, "retryable", () => v), s.export(r, "generatePKCEVerifier", () => w), s.export(r, "generatePKCEChallenge", () => E);
		let a = () => "undefined" != typeof document,
			...
			l = () => {
				...
				try {
					globalThis.localStorage.setItem(e, e), globalThis.localStorage.removeItem(e), o.tested = !0, o.writable = !0
				} catch (e) {
		...
		let h = t => {
				let r;
				return r = t || ("undefined" == typeof fetch ? (...t) => e("b2ccdf67f6d24e8b").then(({
					default: e
				}) => e(...t)) : fetch), (...e) => r(...e)
			},
		...
		function g(e) {
			...
			let l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
				c = "",
				h = 0;
			for (e = e.replace("-", "+").replace("_", "/"); h < e.length;) i = l.indexOf(e.charAt(h++)), n = l.indexOf(e.charAt(h++)), a = l.indexOf(e.charAt(h++)), o = l.indexOf(e.charAt(h++)), t = i << 2 | n >> 4, r = (15 & n) << 4 | a >> 2, s = (3 & a) << 6 | o, c += String.fromCharCode(t), 64 != a && 0 != r && (c += String.fromCharCode(r)), 64 != o && 0 != s && (c += String.fromCharCode(s));
			return c
		}
		class m {
			constructor() {
	...
	c0fws: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "AuthError", () => i), s.export(r, "isAuthError", () => n), s.export(r, "AuthApiError", () => a), s.export(r, "isAuthApiError", () => o), s.export(r, "AuthUnknownError", () => l), s.export(r, "CustomAuthError", () => c), s.export(r, "AuthSessionMissingError", () => h), s.export(r, "AuthInvalidTokenResponseError", () => u), s.export(r, "AuthInvalidCredentialsError", () => d), s.export(r, "AuthImplicitGrantRedirectError", () => p), s.export(r, "AuthPKCEGrantCodeExchangeError", () => f), s.export(r, "AuthRetryableFetchError", () => g), s.export(r, "isAuthRetryableFetchError", () => m);
		class i extends Error {
			constructor(e, t) {
	...
	"9zVxQ": [function(e, t, r) {
		...
		class m {
			constructor(e) {
				var t;
				this.memoryStorage = null, this.stateChangeEmitters = new Map, this.autoRefreshTicker = null, this.visibilityChangedCallback = null, this.refreshingDeferred = null, this.initializePromise = null, this.detectSessionInUrl = !0, this.lockAcquired = !1, this.pendingInLock = [], this.broadcastChannel = null, this.logger = console.log, this.instanceID = m.nextInstanceID, m.nextInstanceID += 1, this.instanceID > 0 && (0, c.isBrowser)() && console.warn("Multiple GoTrueClient instances detected in the same browser context. It is not an error, but this should be avoided as it may produce undefined behavior when used concurrently under the same storage key.");
				let r = Object.assign(Object.assign({}, f), e);
				if (this.logDebugMessages = !!r.debug, "function" == typeof r.debug && (this.logger = r.debug), this.persistSession = r.persistSession, this.storageKey = r.storageKey, this.autoRefreshToken = r.autoRefreshToken, this.admin = new n.default({
						url: r.url,
						headers: r.headers,
						fetch: r.fetch
					}), this.url = r.url, this.headers = r.headers, this.fetch = (0, c.resolveFetch)(r.fetch), this.lock = r.lock || g, this.detectSessionInUrl = r.detectSessionInUrl, this.flowType = r.flowType, this.mfa = {
					...
					}, this.persistSession ? r.storage ? this.storage = r.storage : (0, c.supportsLocalStorage)() ? this.storage = h.localStorageAdapter : (this.memoryStorage = {}, this.storage = (0, h.memoryLocalStorageAdapter)(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = (0, h.memoryLocalStorageAdapter)(this.memoryStorage)), (0, c.isBrowser)() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
					try {
			...
			_debug(...e) {
				return this.logDebugMessages && this.logger(`GoTrueClient@${this.instanceID} (${d.version}) ${new Date().toISOString()}`, ...e), this
			}
			async initialize() {
				...
				try {
					...
					if (await this._removeSession(), "email" in e) {
						...
						if ("pkce" === this.flowType) {
							...
							await (0, c.setItemAsync)(this.storage, `${this.storageKey}-code-verifier`, e), a = await (0, c.generatePKCEChallenge)(e), o = e === a ? "plain" : "s256"
						}
						i = await (0, l._request)(this.fetch, "POST", `${this.url}/signup`, {
							headers: this.headers,
					...
					} else throw new o.AuthInvalidCredentialsError("You must provide either an email or phone number and a password");
					let {
						data: n,
						error: a
					} = i;
					...
					let h = n.session,
						u = n.user;
					return n.session && (await this._saveSession(n.session), await this._notifyAllSubscribers("SIGNED_IN", h)), {
						data: {
							user: u,
							session: h
						},
			...
			async signInWithPassword(e) {
				try {
					...
					if (await this._removeSession(), "email" in e) {
						...
						t = await (0, l._request)(this.fetch, "POST", `${this.url}/token?grant_type=password`, {
							headers: this.headers,
							body: {
								email: r,
								password: s,
					...
					return r.session && (await this._saveSession(r.session), await this._notifyAllSubscribers("SIGNED_IN", r.session)), {
						data: {
							user: r.user,
							session: r.session
						},
			...
			async _exchangeCodeForSession(e) {
				let t = await (0, c.getItemAsync)(this.storage, `${this.storageKey}-code-verifier`),
					{
						data: r,
						error: s
					} = await (0, l._request)(this.fetch, "POST", `${this.url}/token?grant_type=pkce`, {
						headers: this.headers,
						body: {
							auth_code: e,
							code_verifier: t
				...
				return (await (0, c.removeItemAsync)(this.storage, `${this.storageKey}-code-verifier`), s) ? {
					data: {
						user: null,
						session: null
					},
			...
			async signInWithIdToken(e) {
				...
				try {
					let {
						...
						access_token: i,
						nonce: n
					} = e, a = await (0, l._request)(this.fetch, "POST", `${this.url}/token?grant_type=id_token`, {
						headers: this.headers,
						body: {
							provider: r,
							id_token: s,
					...
					return c.session && (await this._saveSession(c.session), await this._notifyAllSubscribers("SIGNED_IN", c.session)), {
						data: c,
						error: h
					}
				} catch (e) {
			...
			async signInWithOtp(e) {
				...
				try {
					if (await this._removeSession(), "email" in e) {
						...
						if ("pkce" === this.flowType) {
							let e = (0, c.generatePKCEVerifier)();
							await (0, c.setItemAsync)(this.storage, `${this.storageKey}-code-verifier`, e), n = await (0, c.generatePKCEChallenge)(e), a = e === n ? "plain" : "s256"
						}
						let {
							error: o
						} = await (0, l._request)(this.fetch, "POST", `${this.url}/otp`, {
							headers: this.headers,
							body: {
								email: s,
			...
			async verifyOtp(e) {
				...
				try {
					let s, i;
					"email_change" !== e.type && "phone_change" !== e.type && await this._removeSession(), "options" in e && (s = null === (t = e.options) || void 0 === t ? void 0 : t.redirectTo, i = null === (r = e.options) || void 0 === r ? void 0 : r.captchaToken);
					let {
						data: n,
						error: a
					} = await (0, l._request)(this.fetch, "POST", `${this.url}/verify`, {
						headers: this.headers,
			...
			async signInWithSSO(e) {
				var t, r, s;
				try {
					return await this._removeSession(), await (0, l._request)(this.fetch, "POST", `${this.url}/sso`, {
			...
			async _reauthenticate() {
				try {
					return await this._useSession(async e => {
						...
						let {
							error: s
						} = await (0, l._request)(this.fetch, "GET", `${this.url}/reauthenticate`, {
							headers: this.headers,
							jwt: t.access_token
						});
						return {
				...
				try {
					...
					if ("email" in e) {
						let {
							...
							error: n
						} = await (0, l._request)(this.fetch, "POST", t, {
							headers: this.headers,
							body: {
								email: r,
								type: s,
			...
			async _getUser(e) {
				try {
					if (e) return await (0, l._request)(this.fetch, "GET", `${this.url}/user`, {
						headers: this.headers,
						jwt: e,
					...
					return await this._useSession(async e => {
						...
						if (i) throw i;
						return await (0, l._request)(this.fetch, "GET", `${this.url}/user`, {
							headers: this.headers,
				...
				try {
					return await this._useSession(async r => {
						...
						if ("pkce" === this.flowType && null != e.email) {
							let e = (0, c.generatePKCEVerifier)();
							await (0, c.setItemAsync)(this.storage, `${this.storageKey}-code-verifier`, e), a = await (0, c.generatePKCEChallenge)(e), h = e === a ? "plain" : "s256"
						}
						let {
							data: u,
							error: d
						} = await (0, l._request)(this.fetch, "PUT", `${this.url}/user`, {
							headers: this.headers,
			...
			async _setSession(e) {
				try {
					if (!e.access_token || !e.refresh_token) throw new o.AuthSessionMissingError;
					let t = Date.now() / 1e3,
						r = t,
						s = !0,
						i = null,
			...
			async _refreshSession(e) {
				try {
					return await this._useSession(async t => {
						...
						if (!(null == e ? void 0 : e.refresh_token)) throw new o.AuthSessionMissingError;
						let {
							session: s,
							error: i
						} = await this._callRefreshToken(e.refresh_token);
			...
			async _getSessionFromURL(e) {
				try {
					if (!(0, c.isBrowser)()) throw new o.AuthImplicitGrantRedirectError("No browser detected.");
					if ("implicit" !== this.flowType || this._isImplicitGrantFlow()) {
						if ("pkce" == this.flowType && !e) throw new o.AuthPKCEGrantCodeExchangeError("Not a valid PKCE flow url.")
					} else throw new o.AuthImplicitGrantRedirectError("Not a valid implicit grant flow url.");
					let t = (0, c.parseParametersFromURL)(window.location.href);
					if (e) {
						if (!t.code) throw new o.AuthPKCEGrantCodeExchangeError("No code detected.");
						let {
							data: e,
							error: r
					...
					if (t.error || t.error_description || t.error_code) throw new o.AuthImplicitGrantRedirectError(t.error_description || "Error in URL with unspecified error_description", {
					...
					if (!i || !a || !n || !h) throw new o.AuthImplicitGrantRedirectError("No session defined in URL");
					...
					let g = p - d;
					u - g >= 120 ? console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued over 120s ago, URL could be stale", g, p, u) : u - g < 0 && console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued in the future? Check the device clok for skew", g, p, u);
					let {
						data: m,
						error: b
			...
			_isImplicitGrantFlow() {
				...
				return !!((0, c.isBrowser)() && (e.access_token || e.error_description))
			}
			async _isPKCEFlow() {
				let e = (0, c.parseParametersFromURL)(window.location.href),
					t = await (0, c.getItemAsync)(this.storage, `${this.storageKey}-code-verifier`);
				return !!(e.code && t)
			}
			async signOut(e = {
				scope: "global"
			...
			async _signOut({
				...
				return await this._useSession(async t => {
					...
					if (n) {
						...
						if (t && !((0, o.isAuthApiError)(t) && (404 === t.status || 401 === t.status))) return {
							error: t
						}
					}
					return "others" !== e && (await this._removeSession(), await (0, c.removeItemAsync)(this.storage, `${this.storageKey}-code-verifier`), await this._notifyAllSubscribers("SIGNED_OUT", null)), {
						error: null
					}
				})
			}
			...
			async _emitInitialSession(e) {
				return await this._useSession(async t => {
					...
					try {
						...
						if (i) throw i;
						await (null === (r = this.stateChangeEmitters.get(e)) || void 0 === r ? void 0 : r.callback("INITIAL_SESSION", s)), this._debug("INITIAL_SESSION", "callback id", e, "session", s)
					} catch (t) {
						await (null === (s = this.stateChangeEmitters.get(e)) || void 0 === s ? void 0 : s.callback("INITIAL_SESSION", null)), this._debug("INITIAL_SESSION", "callback id", e, "error", t), console.error(t)
					}
				})
			}
			async resetPasswordForEmail(e, t = {}) {
				...
				if ("pkce" === this.flowType) {
					let e = (0, c.generatePKCEVerifier)();
					await (0, c.setItemAsync)(this.storage, `${this.storageKey}-code-verifier`, e), r = await (0, c.generatePKCEChallenge)(e), s = e === r ? "plain" : "s256"
				}
				try {
					return await (0, l._request)(this.fetch, "POST", `${this.url}/recover`, {
						body: {
							email: e,
							code_challenge: r,
			...
			async _refreshAccessToken(e) {
				...
				try {
					let r = Date.now();
					return await (0, c.retryable)(async r => (await (0, c.sleep)(200 * r), this._debug(t, "refreshing attempt", r), await (0, l._request)(this.fetch, "POST", `${this.url}/token?grant_type=refresh_token`, {
						body: {
							refresh_token: e
						},
						headers: this.headers,
						xform: l._sessionResponse
					})), (e, t, s) => s && s.error && (0, o.isAuthRetryableFetchError)(s.error) && Date.now() + (e + 1) * 200 - r < 3e4)
				} catch (e) {
					if (this._debug(t, "error", e), (0, o.isAuthError)(e)) return {
						data: {
							session: null,
							user: null
						},
			...
			async _handleProviderSignIn(e, t) {
				...
				return this._debug("#_handleProviderSignIn()", "provider", e, "options", t, "url", r), (0, c.isBrowser)() && !t.skipBrowserRedirect && window.location.assign(r), {
					data: {
						provider: e,
						url: r
					},
			...
			async _recoverAndRefresh() {
				...
				this._debug(t, "begin");
				try {
					let r = await (0, c.getItemAsync)(this.storage, this.storageKey);
					...
					if (this._debug(t, `session has${i?"":" not"} expired with margin of ${a.EXPIRY_MARGIN}s`), i) {
						if (this.autoRefreshToken && r.refresh_token) {
							let {
								error: e
							} = await this._callRefreshToken(r.refresh_token);
							e && (console.error(e), (0, o.isAuthRetryableFetchError)(e) || (this._debug(t, "refresh failed with a non-retryable error, removing the session", e), await this._removeSession()))
						}
			...
			_persistSession(e) {
				return this._debug("#_persistSession()", e), (0, c.setItemAsync)(this.storage, this.storageKey, e)
			}
			async _removeSession() {
				this._debug("#_removeSession()"), await (0, c.removeItemAsync)(this.storage, this.storageKey)
			}
			_removeVisibilityChangedCallback() {
				...
				try {
					e && (0, c.isBrowser)() && (null == window ? void 0 : window.removeEventListener) && window.removeEventListener("visibilitychange", e)
				} catch (e) {
			...
			async _autoRefreshTokenTick() {
				...
				try {
						...
						try {
							...
							try {
								return await this._useSession(async t => {
									...
									this._debug("#_autoRefreshTokenTick()", `access token expires in ${s} ticks, a tick lasts 30000ms, refresh threshold is 3 ticks`), s <= 3 && await this._callRefreshToken(r.refresh_token)
								})
							} catch (e) {
					...
					if (e.isAcquireTimeout || e instanceof p.LockAcquireTimeoutError) this._debug("auto refresh token tick lock not available");
					else throw e
				}
			}
			async _handleVisibilityChange() {
				if (this._debug("#_handleVisibilityChange()"), !(0, c.isBrowser)() || !(null == window ? void 0 : window.addEventListener)) return this.autoRefreshToken && this.startAutoRefresh(), !1;
				try {
			...
			async _getUrlForProvider(e, t) {
				...
				if ((null == t ? void 0 : t.redirectTo) && r.push(`redirect_to=${encodeURIComponent(t.redirectTo)}`), (null == t ? void 0 : t.scopes) && r.push(`scopes=${encodeURIComponent(t.scopes)}`), "pkce" === this.flowType) {
					let e = (0, c.generatePKCEVerifier)();
					await (0, c.setItemAsync)(this.storage, `${this.storageKey}-code-verifier`, e);
				...
				try {
					return await this._useSession(async t => {
						...
						return i ? {
							data: null,
							error: i
						} : await (0, l._request)(this.fetch, "DELETE", `${this.url}/factors/${e.factorId}`, {
							headers: this.headers,
				...
				try {
					return await this._useSession(async t => {
						...
						let {
							data: a,
							error: o
						} = await (0, l._request)(this.fetch, "POST", `${this.url}/factors`, {
							body: {
					...
					try {
						return await this._useSession(async t => {
							...
							let {
								data: n,
								error: a
							} = await (0, l._request)(this.fetch, "POST", `${this.url}/factors/${e.factorId}/verify`, {
								body: {
									code: e.code,
					...
					try {
						return await this._useSession(async t => {
							...
							return i ? {
								data: null,
								error: i
							} : await (0, l._request)(this.fetch, "POST", `${this.url}/factors/${e.factorId}/challenge`, {
								headers: this.headers,
								jwt: null === (r = null == s ? void 0 : s.session) || void 0 === r ? void 0 : r.access_token
							})
						})
	...
	i2jrv: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "GOTRUE_URL", () => n), s.export(r, "STORAGE_KEY", () => a), s.export(r, "AUDIENCE", () => o), s.export(r, "DEFAULT_HEADERS", () => l), s.export(r, "EXPIRY_MARGIN", () => c), s.export(r, "NETWORK_FAILURE", () => h);
		var i = e("./version");
	...
	fPyo9: [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "localStorageAdapter", () => n), s.export(r, "memoryLocalStorageAdapter", () => a);
		var i = e("./helpers");
		let n = {
			getItem: e => (0, i.supportsLocalStorage)() ? globalThis.localStorage.getItem(e) : null,
			setItem: (e, t) => {
				(0, i.supportsLocalStorage)() && globalThis.localStorage.setItem(e, t)
			},
			removeItem: e => {
				(0, i.supportsLocalStorage)() && globalThis.localStorage.removeItem(e)
			}
		};
	...
	"9CO74": [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "internals", () => n), s.export(r, "LockAcquireTimeoutError", () => a), s.export(r, "NavigatorLockAcquireTimeoutError", () => o), s.export(r, "navigatorLock", () => l);
		var i = e("./helpers");
		let n = {
			debug: !!(globalThis && (0, i.supportsLocalStorage)() && globalThis.localStorage && "true" === globalThis.localStorage.getItem("supabase.gotrue-js.locks.debug"))
		};
		...
		async function l(e, t, r) {
			...
			return t > 0 && setTimeout(() => {
				s.abort(), n.debug && console.log("@supabase/gotrue-js: navigatorLock acquire timed out", e)
				...
				} else if (0 === t) throw n.debug && console.log("@supabase/gotrue-js: navigatorLock: not immediately available", e), new o(`Acquiring an exclusive Navigator LockManager lock "${e}" immediately failed`);
				else {
					if (n.debug) try {
	...
	huVuo: [function(e, t, r) {
		...
		let i = new s.Storage({
			...
			n = async (e, t) => {
				try {
					await i.set("my_x_account", e.data), t.send({
						success: !0
					})
				} catch (e) {
					t.send({
			...
			n = async (e, t) => {
				try {
					let r = await i.get("latestTimeline"),
						s = r ?? [];
					s = (s = (s = s.concat(e.toSave)).slice(-400)).filter((e, t, r) => t === r.findIndex(t => t.id === e.id)), await i.set("latestTimeline", s), t.send({
						success: !0
					})
				} catch (e) {
					t.send({
			...
			n = async (e, t) => {
				try {
					let r = await i.get("latestTweets"),
						s = r ?? [];
					s.push(e.tweetData), s.length > 10 && s.shift(), await i.set("latestTweets", s), t.send({
						success: !0
					})
				} catch (e) {
					t.send({
	...
	"3Ce5h": [function(e, t, r) {
		var s = e("@parcel/transformer-js/src/esmodule-helpers.js");
		s.defineInteropFlag(r), s.export(r, "v1", () => n.default), s.export(r, "v3", () => o.default), s.export(r, "v4", () => c.default), s.export(r, "v5", () => u.default), s.export(r, "NIL", () => p.default), s.export(r, "version", () => g.default), s.export(r, "validate", () => b.default), s.export(r, "stringify", () => v.default), s.export(r, "parse", () => w.default);
		var i = e("./v1.js"),
			n = s.interopDefault(i),
			a = e("./v3.js"),
			o = s.interopDefault(a),
	...
	d8naC: [function(e, t, r) {
		...
		r.default = function(e, t, r) {
			if (n.default.randomUUID && !t && !e) return (0, n.default).randomUUID();
			e = e || {};
	...
	"9Sfn8": [function(e, t, r) {
		...
		function a() {
			if (!s && !(s = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto))) throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
			return s(n)
		}
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "hbR2Q"
	...
	gF42W: [function(e, t, r) {
		e("@parcel/transformer-js/src/esmodule-helpers.js").defineInteropFlag(r), r.default = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i
	}, {
		"@parcel/transformer-js/src/esmodule-helpers.js": "hbR2Q"
	}],
...
}, ["cq3XM", "kgW6q"], "kgW6q", "parcelRequirea88a"), globalThis.define = t;